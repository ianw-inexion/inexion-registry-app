...
_PAGES = {
    ...
    "Cohort Explorers": [
        st.Page("app_pages/3e_Clinic_Explorer.py",
                 title="Clinic Explorer",
                 icon=":material/local_hospital:"),
        st.Page("app_pages/1_NHANES_Explorer.py",
                 title="NHANES Explorer",
                 icon=":material/biotech:"),
        st.Page("app_pages/2_HRS_Explorer.py",
                 title="HRS Explorer",
                 icon=":material/biotech:"),
        st.Page("app_pages/3_MIDUS_Explorer.py",
                 title="MIDUS Explorer",
                 icon=":material/biotech:"),
        st.Page("app_pages/3c_NSHAP_Explorer.py",
                 title="NSHAP Explorer",
                 icon=":material/biotech:"),
        st.Page("app_pages/3d_GEO_Explorer.py",
                 title="GEO Explorer",
                 icon=":material/genetics:"),
        st.Page("app_pages/3_Market_Intelligence.py",
                 title="Market Intelligence",
                 icon=":material/explore:"),
    ],
    "Patient Tools": [
        st.Page("app_pages/4_Patient_Analysis.py",
    ...
    "Clocks & Validation": [
        ...
        st.Page("app_pages/6_Organ_Ages.py",
                 title="Organ Ages",
                 icon=":material/favorite:"),
        st.Page("app_pages/6b_Methylation_Clocks.py",
                 title="Methylation Clocks",
                 icon=":material/genetics:"),
        st.Page("app_pages/6c_Pathway_Decomposition.py",
                 title="Pathway Decomposition",
                 icon=":material/network_intel_node:"),
    ],
    "Research": [
        st.Page("app_pages/7_Research_Workbench.py",
                 title="Research Workbench",
                 icon=":material/science:"),
    ],
    "Reference & Admin": [
        st.Page("app_pages/8_Dataset_Catalog.py",
                 title="Dataset Catalog",
                 icon=":material/folder:"),
        st.Page("app_pages/9_Variable_Dictionary.py",
                 title="Variable Dictionary",
                 icon=":material/menu_book:"),
        st.Page("app_pages/10_Admin.py",
                 title="Admin",
