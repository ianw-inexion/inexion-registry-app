...
PAGES = [
    ...
    ("4. Biological Age Calculator",  "Enter 9 lab values or upload PDF lab report - Computes PhenoAge + delta + 10-yr mortality risk"),
    ("5. Normative Reference",        "Percentile lookup - where does a patient stand vs. the U.S. population for their age-sex group?"),
    ("6. Intervention Simulator",     "Biomarker contribution waterfall - Simulate treatment targets - Real-time PhenoAge update - PDF upload"),
