...
with tabs[0]:
    ...
    # Impairment quintile table
    filt2 = filt[filt['r13agey_b'].between(50,95)].copy()
    # Try to merge cognitive data
    if not survey.empty:
